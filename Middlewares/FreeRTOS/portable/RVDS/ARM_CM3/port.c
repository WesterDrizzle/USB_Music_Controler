...
#define portVECTACTIVE_SHIFT (0) // 活动中断的位移
// 获取当前活动中断的函数
uint32_t getActiveInterrupt(void)
{
	return (portNVIC_INT_CTRL_REG & portVECTACTIVE_MASK) >> portVECTACTIVE_SHIFT;
}
